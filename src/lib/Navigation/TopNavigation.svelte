<script lang="ts">
	...
	const topNavigation: PopupSettings = {
		event: 'click',
		target: 'topNavigation',
		placement: 'bottom',
	};
</script>

<button class="hover:variant-soft-primary btn" use:popup={topNavigation}>
	<span>Menu</span>
...
<div
	...
	<nav class="list-nav">
		<ul>
			...
			<li>
				<a href="https://www.skeleton.dev/blog"
					><span class="w-6 text-center"><iconify-icon icon="fa-bullhorn" /></span>
					<span>Blog</span></a>
			</li>
			<hr class="!my-4" />
			<li>
				<a href="https://www.skeleton.dev/elements/core"
					><span class="w-6 text-center"
						><svg
							...
							class="svg-icon inline-block h-5 w-5 fill-current outline-none"
							focusable="false"
						...
						></span> <span>Tailwind</span></a>
			</li>
			<li>
				<a href="https://www.skeleton.dev/actions/clipboard"
					><span class="w-6 text-center"
						><svg
							xmlns="http://www.w3.org/2000/svg"
							x="0px"
